...
;// ../../data/manifests/gibson/manifest_gibson.json
const manifest_gibson_namespaceObject = /*#__PURE__*/JSON.parse('{"schema":"reclaw.video_manifest.v2","framework":"HHVCTA","metadata":{"project":"Project Reclaw","generated_at":"2026-07-06T09:58:14.760430+00:00","target":"Gibson","anomaly":"salary_shock","anomaly_key":"salary_shock","render_resolution":[1080,1920],"fps":30,"duration_s":60,"review_id":null},"audio_pipeline":{"tts_provider":"elevenlabs","voice_id":"EXAVITQu4vr4xnSDxMaL","bgm":"suspense_drone_01.mp3","captions":"whisper.cpp → @remotion/captions"},"atomic_finding":{"category":"salary_shock","severity":"high","data_point":"$111K","provenance":"Indiana Gateway","description":"Public compensation records show $111K. In a small county, that\'s a legitimate taxpayer question — not an accusation."},"scenes":[{"scene_id":1,"type":"HOOK","hhvcta":"hook","duration_seconds":3,"text_overlay":"PUBLIC RECORD","spoken_script":"Gibson County paid Sheriff $111K — public record.","visual_asset":"courthouse_stock_darkened","vfx":"subtle_camera_push"},{"scene_id":2,"type":"HINT","hhvcta":"hint","duration_seconds":2.5,"text_overlay":"The Math Is Public","spoken_script":"Forensic accountants use these tests on public ledgers. So can taxpayers.","visual_asset":"benford_chart_skeleton","vfx":"glitch_transition"},{"scene_id":3,"type":"VALUE","hhvcta":"value","duration_seconds":12,"text_overlay":"Flag: $111K","spoken_script":"Public compensation records show $111K. In a small county, that\'s a legitimate taxpayer question — not an accusation.","visual_asset":"dynamic_chart_render","chart":{"type":"bar_highlight","highlight":"$111K"},"vfx":"zoom_in_on_chart"},{"scene_id":4,"type":"CREDIBILITY","hhvcta":"credibility","duration_seconds":4,"text_overlay":"Source: Indiana Gateway","spoken_script":"This isn\'t rumor. It\'s from Indiana Gateway — pulled from official open records.","visual_asset":"screenshot_open_data_portal","vfx":"highlight_source_url"},{"scene_id":5,"type":"TAKEAWAY","hhvcta":"takeaway","duration_seconds":4,"text_overlay":"Your Tax Dollars","spoken_script":"It\'s your tax money. Fair questions deserve answers on the record.","visual_asset":"data_table_scroll","vfx":null},{"scene_id":6,"type":"ACTION","hhvcta":"action","duration_seconds":4,"text_overlay":"Tag Gibson","spoken_script":"If you live in Gibson, tag your local officials and ask them to explain this line at the next public meeting.","visual_asset":"cta_subscribe_card","vfx":"red_border_pulse"}],"beats":{"hook":{"start_s":0,"end_s":3,"text":"Gibson County paid Sheriff $111K — public record.","on_screen":"Gibson County paid Sheriff $111K — public record."},"hint":{"start_s":3,"end_s":5.5,"text":"Forensic accountants use these tests on public ledgers. So can taxpayers."},"value":{"start_s":5.5,"end_s":17.5,"text":"Public compensation records show $111K. In a small county, that\'s a legitimate taxpayer question — not an accusation."},"credibility":{"start_s":17.5,"end_s":21.5,"text":"This isn\'t rumor. It\'s from Indiana Gateway — pulled from official open records.","on_screen":"This isn\'t rumor. It\'s from Indiana Gateway — pulled from official open records."},"takeaway":{"start_s":21.5,"end_s":25.5,"text":"It\'s your tax money. Fair questions deserve answers on the record."},"action":{"start_s":25.5,"end_s":29.5,"text":"If you live in Gibson, tag your local officials and ask them to explain this line at the next public meeting.","cta":"subscribe"}},"word_count":82,"disclaimer":"Patterns in public financial records only. Not an allegation of crime or wrongdoing."}');
;// ./src/loadManifest.ts
...
function buildChartData(manifest) {
  const finding = manifest.atomic_finding;
  const amount = parseDollarAmount(finding == null ? void 0 : finding.data_point);
  const category = (finding == null ? void 0 : finding.category) ?? "flag";
  const baseline = Math.max(amount * 0.35, 25e3);
...
function sceneFromBeat(hhvcta, beat, onScreenFallback) {
  const start = beat.start_s ?? 0;
  const end = beat.end_s ?? start + 3;
  const bursts = beat.on_screen ? beat.on_screen.split(/[·|]/).map((s) => s.trim()).filter(Boolean).slice(0, 3) : onScreenFallback;
  return {
...
function scenesFromManifest(manifest) {
  var _a, _b;
  const scriptBody = manifest.script_body ?? ((_a = manifest.scribe) == null ? void 0 : _a.script_body) ?? null;
  if (scriptBody == null ? void 0 : scriptBody.length) {
    return scriptBody;
  }
  if (manifest.beats) {
    const order = ["hook", "hint", "value", "credibility", "takeaway", "action"];
    const defaults = {
      hook: ["PUBLIC RECORD"],
      hint: ["PATTERN FOUND"],
      value: ["THE DATA"],
    ...
    return order.filter((k) => {
      var _a2;
      return (_a2 = manifest.beats) == null ? void 0 : _a2[k];
    }).map((k) => sceneFromBeat(k, manifest.beats[k], defaults[k] ?? ["RECLAW"]));
  }
  if ((_b = manifest.scenes) == null ? void 0 : _b.length) {
    let cursor = 0;
...
function copyField(manifest, key, scenes, fallback = "") {
  var _a, _b, _c;
  const scribeCopy = (_b = (_a = manifest.scribe) == null ? void 0 : _a.copy) == null ? void 0 : _b[key];
  if (scribeCopy) return scribeCopy;
  const scene = scenes.find((s) => s.hhvcta === key);
  if (scene == null ? void 0 : scene.spoken_script) return scene.spoken_script;
  const beat = (_c = manifest.beats) == null ? void 0 : _c[key];
  if (beat == null ? void 0 : beat.text) return beat.text;
  return fallback;
}
function resolveRenderMode(manifest, scenes) {
  var _a, _b, _c;
  if (((_a = manifest.metadata) == null ? void 0 : _a.render_mode) === "hhvcta") return "hhvcta";
  if (((_b = manifest.metadata) == null ? void 0 : _b.render_mode) === "classic") return "classic";
  const scriptBody = manifest.script_body ?? ((_c = manifest.scribe) == null ? void 0 : _c.script_body);
...
function loadManifest(manifest) {
  ...
  const city = ((_a = manifest.metadata) == null ? void 0 : _a.target) ?? manifest.county ?? "County";
  const fps = ((_b = manifest.metadata) == null ? void 0 : _b.fps) ?? DEFAULT_FPS;
  const renderMode = resolveRenderMode(manifest, scenes);
  const hookText = manifest.hook_text ?? ((_c = manifest.scribe) == null ? void 0 : _c.hook_text) ?? copyField(manifest, "hook", scenes, "Public records show a pattern worth questioning.");
  const valueText = copyField(
    manifest,
    "value",
    scenes,
    ((_d = manifest.atomic_finding) == null ? void 0 : _d.description) ?? "The flagged line is in the public checkbook."
  );
  const durationS = renderMode === "hhvcta" ? ((_e = manifest.metadata) == null ? void 0 : _e.duration_s) ?? (scenes.length ? Math.max(...scenes.map((s) => s.end_s)) : HHVCTA_DURATION_S) : CLASSIC_DURATION_S;
  return {
    city,
    hookText,
    valueText,
    sourceText: ((_f = manifest.atomic_finding) == null ? void 0 : _f.provenance) ?? "Indiana Gateway",
    ...
    credibilityText: copyField(
      ...
      "credibility",
      scenes,
      `Source: ${((_g = manifest.atomic_finding) == null ? void 0 : _g.provenance) ?? "Indiana Gateway public records"}`
    ),
    ...
    disclaimer: manifest.disclaimer ?? "Patterns in public financial records only. Not an allegation of crime or wrongdoing.",
    scenes,
    fps,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: data.map((item, index) => {
        ...
        const currentHeight = (0,esm.interpolate)(animationProgress, [0, 1], [0, targetHeight]);
...
;// ./src/SceneOverlay.tsx



const SceneOverlay = ({ bursts, accent = "#ef4444" }) => {
  const frame = (0,esm.useCurrentFrame)();
  const opacity = (0,esm.interpolate)(frame, [0, 8], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
      ...
      children: bursts.map((text, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "span",
        {
          style: {
            padding: "10px 18px",
...
;// ./src/ReclawComposition.tsx





const ReclawComposition_CLASSIC_DURATION_S = 16;
const GridBackground = () => /* @__PURE__ */ (0,jsx_runtime.jsx)(
  "div",
  {
    style: {
      position: "absolute",
...
const BrandHeader = ({ city }) => {
  const frame = (0,esm.useCurrentFrame)();
  const pulse = (0,esm.interpolate)(frame % 60, [0, 30, 60], [1, 1.35, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
        ...
        children: [
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "span",
            {
              ...
              children: [
                "RECLAW ",
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: "#ef4444" }, children: "AUDIT" })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("span", { style: { fontSize: 24, color: "#94a3b8", fontFamily: "monospace" }, children: [
          "TARGET: ",
          city.toUpperCase()
        ] })
      }
...
const ClassicComposition = ({
  ...
  const titleY = (0,esm.interpolate)(frame, [0, 15], [50, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(GridBackground, {}),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(BrandHeader, { city }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: fps * 4, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.AbsoluteFill,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: fps * 4, durationInFrames: fps * 8, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { justifyContent: "center", padding: 60 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: "translateY(-100px)" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(DynamicChart, { data: chartData }) }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: fps * 12, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          esm.AbsoluteFill,
          {
            style: {
              justifyContent: "center",
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "h2",
                {
                  ...
                  children: "THE MATH IS PUBLIC."
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("p", { style: { fontSize: 36, color: "#fca5a5", fontFamily: "monospace" }, children: [
                "Source: ",
                sourceText
              ] }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: "TAG YOUR CITY COUNCIL"
                }
              )
            ]
          }
        ) }),
        disclaimer && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
...
const HhvctaScene = ({
  ...
  if (hhvcta === "value") {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { justifyContent: "center", padding: 60 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneOverlay, { bursts: on_screen_text, accent: "#6366f1" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: "translateY(-100px)" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(DynamicChart, { data: props.chartData }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
          ...
          children: /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: { fontSize: 42, fontWeight: 600, lineHeight: 1.4, margin: 0 }, children: spoken_script || props.valueText })
        }
      )
    ] });
  }
  if (hhvcta === "credibility" || hhvcta === "action") {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      esm.AbsoluteFill,
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneOverlay, { bursts: on_screen_text, accent: "#ffffff" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: { fontSize: 64, fontWeight: 900, color: "white", textAlign: "center" }, children: hhvcta === "action" ? "TAG YOUR OFFICIALS" : "THE MATH IS PUBLIC." }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: { fontSize: 36, color: "#fca5a5", fontFamily: "monospace", marginTop: 20 }, children: hhvcta === "credibility" ? `Source: ${props.sourceText}` : spoken_script || props.actionText })
        ]
      }
    );
  }
  ...
  const titleOpacity = (0,esm.interpolate)(frame, [0, 15], [0, 1], { extrapolateRight: "clamp" });
  const titleY = (0,esm.interpolate)(frame, [0, 15], [50, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { justifyContent: "center", alignItems: "center", padding: 80 }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneOverlay, { bursts: on_screen_text }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "h1",
      {
        style: {
        ...
        children: spoken_script || props.hookText
      }
    )
  ] });
};
const ReclawComposition = (props) => {
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(GridBackground, {}),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(BrandHeader, { city: props.city }),
        scenes.map((scene) => {
          ...
          return /* @__PURE__ */ (0,jsx_runtime.jsx)(
            esm.Sequence,
            {
              from,
              durationInFrames,
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HhvctaScene, { scene, props })
            },
            `${scene.hhvcta}-${scene.start_s}`
          );
        }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
...
function resolveManifest() {
  const input = (0,esm.getInputProps)();
  if ((input == null ? void 0 : input.schema) || (input == null ? void 0 : input.beats) || (input == null ? void 0 : input.metadata) || (input == null ? void 0 : input.scenes)) {
    return input;
  }
  return manifest_gibson_namespaceObject;
}
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(952), __webpack_require__.e(571), __webpack_require__.e(226)]).then(__webpack_require__.bind(__webpack_require__, 571)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "reclaw-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkreclaw_remotion"] = self["webpackChunkreclaw_remotion"] || [];
