...
- For any book/PDF extraction ("Using AI Agents to Make Money" or similar), automatically distill and use `from core.knowledge import get_knowledge_manager; km.save_to_backlog(...)`. No asking user. Target `Ravenstack/backlog/`. Tie to visual dashboard sprites and Clawsmith room design.
