---
name: research_lab_9397cb41
description: Persistent research_lab cell for rural Indiana passive income. Chief: researcher. Total-ReClaw memory + visual desk.
requires_env: ["OPENAI_API_KEY"]
requires_bins: ["curl", "sqlite3", "openclaw"]
user-invocable: false
---
# SOUL - Research Lab (Clawforge compiled for Hetzner)
